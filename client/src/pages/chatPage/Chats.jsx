      ...
      <AnimatePresence>
        {!newChat ? (
          <motion.div
            id="chats"
            key={"chat"}
            className={`bg-[#0f3a50] sm:max-xl:w-[40%] w-[30%] ${
              !selectedChat ? "xs:max-sm:w-screen" : "xs:max-sm:hidden"
            }  h-screen border-r-[1px] border-solid border-gray-500`}
            initial={{ x: 0 }}
            exit={{ x: 0, position: "absolute" }}
            transition={{ ease: "easeIn", type: "tween", duration: ".3" }}
          >
            <div className="h-[3.8rem] bg-[#355070] flex items-center justify-between sticky top-0">
              ...
              <div className="flex w-1/2 justify-end space-x-3 mr-5">
                ...
                <div
                  ...
                  className={
                    menu
                      ? "bg-[#033748] rounded-full w-10 h-10 flex items-center justify-center"
                ...
                <div
                  ...
                  className={
                    menu
                      ? "absolute bg-[#033748] text-slate-300 right-8 top-14 min-h-20 w-[12rem] py-4 rounded-lg"
                      : "hidden"
                  }
                >
            ...
            {loading ? (
              ...
              <div className="h-[calc(100vh-3.8rem)] overflow-auto">
                {chats &&
                  chats.map((chat) => (
                    <div
                      className={`flex items-center  justify-start max-w-full h-[4.5rem] hover:bg-[#8d99ae40] focus:bg-[#8d99ae40] cursor-pointer ${
                        selected == chat._id &&
                        "xs:max-sm:bg-none bg-[#8d99ae40]"
                      }`}
                      key={chat._id}
                      onClick={() => {
              ...
              <div className="h-[calc(100vh-3.8rem)] flex items-center justify-center">
                <span className="text-[#e2e8f0] text-xl font-bold">
                  ...
                  <svg
                    ...
                    className="h-5 inline fill-white"
                    height="48"
