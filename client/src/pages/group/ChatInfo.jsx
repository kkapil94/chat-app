...
export default function ChatInfo({groupInfo,chatInfo}) {
  ...
  return (
    <><AnimatePresence>
        ...
        <motion.div className='xs:max-sm:w-screen sm:max-xl:w-[60vw] w-[30vw] h-screen overflow-auto' key={"chatInfo"} initial={{x:"100vh"}} animate={{x:0}} transition={{type:"tween",duration:.2}} exit={{x:"0",position:"absolute"}}>
