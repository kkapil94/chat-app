...
export default function ConfirmGroup({handleConfirmGroup,groupMembers,back}) {
  ...
  return (<>
            <div id="chats" className="bg-[#27374D] w-[30%] h-screen">
                    ...
                    <form ref={form} className='flex flex-col items-center justify-center h-[calc(100vh-6rem)] space-y-12 w-full overflow-auto'>
                        <div className='rounded-full bg-slate-600 flex items-center justify-center '>
                            ...
                            <span className='relative'>
                                ...
                                <div className='absolute left-16 bottom-16 '>
                                    ...
                                    <input id='avatar' name='file' type="file" className='hidden' value={file} onChange={(e)=>setFile(e.target.value)}/>
                                </div>
                            </span>
                            </label>
                        </div>
                        <div className='flex flex-col items-start w-full px-8'>
                            <input type="text" name='name' id='groupName' value={name} onChange={(e)=>setName(e.target.value)} className='w-full outline-none h-8 bg-[#27374D] border-b-2 text-[#a2acb4]' placeholder='Enter Group name'/>
                        </div>
